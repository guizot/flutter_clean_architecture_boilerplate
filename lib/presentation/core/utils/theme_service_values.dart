...
class ThemeServiceValues {
  ...
  static const List<String> colorString = [colorRed, colorGreen, colorBlue, colorOrange, colorPurple, colorYellow];
  static const List<Color> colorValue = [Colors.red, Colors.green, Colors.blue, Colors.orange, Colors.purple, Colors.yellow];
